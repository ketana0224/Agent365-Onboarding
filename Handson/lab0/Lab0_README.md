...
| **[Lab2-1](../lab2/lab2-1_全体概要.md)** | Agent（Agent ID 付き） | アクセス主体として統制・ブロック可 | Blueprint 由来の **Microsoft Entra Agent ID（SP）**（`aiTeammate=false`） | CA / Purview / Defender / Entra ID governance が**自動適用** |
...
| **[Lab2-1](../lab2/lab2-1_全体概要.md)** | `custom-maf-agent-a365`（Blueprint `bec873dd…` / Instance SP `3cdf5ac9…`・`aiTeammate=false`） | Agent ID 発行済み（Registration `T_13d79b9c…`） |
...
| Lab1-2 | [lab2-1_全体概要.md](../lab2/lab2-1_全体概要.md) | Agent ID 付き（CA でブロック可・Purview/Defender 自動） |
